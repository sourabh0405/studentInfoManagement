...
<html lang="en">
  <head>
    ...
    <style>
        ...
        /* Set text color of student entries to white */
        .student-entry {
            color: #fff !important;
        }
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="index.php?page=all-student" class="list-group-item list-group-item-action student-entry"><i class="fa fa-users"></i> All Students</a>
